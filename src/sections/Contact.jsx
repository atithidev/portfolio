const Contact = () => {
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          ...
          <a
            ...
            className="bg-blue-600 hover:bg-blue-700 px-8 py-3 rounded-lg transition font-medium"
          >
            Send Email
          </a>
  ...
  className="border border-blue-600 hover:bg-blue-600 px-8 py-3 rounded-lg transition font-medium duration-300"
>
  LinkedIn
</a>
